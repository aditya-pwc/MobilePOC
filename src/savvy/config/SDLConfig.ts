 ...
 * @Description:
 * @Author: Aimee Zhang
 * @Date: 2021-11-23 00:39:10
 * @LastEditTime: 2023-12-07 14:07:51
...
const SDLConfig = {
    name: Persona.SALES_DISTRICT_LEADER,
    tab: [
        CommonLabel.COPILOT,
        CommonLabel.MY_DAY,
        CommonLabel.MY_TEAM,
    ...
    objs: [
        ...
        },
        {
            ...
            initQuery: `SELECT Id,CountryCode, Name, Street, City, State, Country, PostalCode, Latitude, Longitude, 
                ...
                LocationId, Account.CUST_GEOFNC__c, Account.CUST_UNIQ_ID_VAL__c, LastModifiedDate, 
                ...
                Account.Serves_Dinner__c, Account.Go_Kart_Flag__c, Account.IsOTSCustomer__c ,Account.change_initiated__c,
                Account.IsCDACustomer__c,Account.CDA_Status__c,Account.CDA_Medal__c,Account.CDA_NY_Status__c, Account.IsOTSFoodService__c,
                Customer_Latitude__c,Customer_Longitude__c,Account.GSC_ID__c FROM RetailStore WHERE Account.LOC_PROD_ID__c = APPLY_USER_LOCATION`,
            optimization: true,
        ...
        },
        {
            ...
            initQuery:
                ...
                "relationship_active__c, RecordTypeId, Schedule_Favorited__c, Manager_Directs__c, Is_Night_Shift__c FROM User_Stats__c WHERE USER__r.GM_LOC_ID__c = APPLY_USER_LOCATION AND RecordType.DeveloperName = 'Stats'",
            optimization: true,
        ...
        },
        {
            ...
            initQuery:
                ...
                'Merchandising_Base_Minimum_Requirement__c, CUST_GEOFNC__c, CUST_ID__c, Merchandising_Order_Days__c, Merchandising_Delivery_Days__c, ' +
