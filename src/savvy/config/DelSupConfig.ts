 ...
 * @Description:
 * @Author: Chris
 * @Date: 2021-11-23 00:39:02
 * @LastEditTime: 2023-12-07 14:07:39
...
const DelSupConfig = {
    name: Persona.DELIVERY_SUPERVISOR,
    tab: [
        CommonLabel.COPILOT,
        CommonLabel.MY_DAY,
        CommonLabel.MY_TEAM,
    ...
    objs: [
        ...
        Mission_Id__mdt,
        {
            ...
            initQuery:
                ...
                ' FROM Event WHERE isChild = false AND StartDateTime >= LAST_N_DAYS:14:TIME AND Location__c = APPLY_USER_LOCATION',
            optimization: true,
        ...
        },
        {
            ...
            initQuery: `SELECT Id, CountryCode, Name, Street, City, State, Country, PostalCode, Latitude, Longitude, 
                ...
                Account.Serves_Dinner__c, Account.Go_Kart_Flag__c, Account.change_initiated__c,Account.IsCDACustomer__c,Account.IsOTSCustomer__c,Account.CDA_Medal__c, 
                Customer_Latitude__c, Customer_Longitude__c FROM RetailStore WHERE Account.LOC_PROD_ID__c = APPLY_USER_LOCATION`,
            optimization: true,
            optimizationQuery: ' AND Account.Merchandising_Base_Minimum_Requirement__c = true',
            fieldList: [
                {
                    name: 'Id',
                    type: 'string'
        ...
        },
        {
            ...
            initQuery:
                ...
                'GM_LOC_NM__c, PERSONA__c, GPID__c, BU_ID__c,IsActive, Title, FT_EMPLYE_FLG_VAL__c, USER_ACTIVE__c, ProfileId, ' +
                'SmallPhotoUrl, Merchandising_Base_Minimum_Requirement__c, LC_ID__c, WRKFRC_EMPLYMT_TRMNTN_DT__c, ' +
                'ADDR_LN_1_TXT__c, EMPLYMT_TYP_NM__c, ADDR_LN_2_TXT__c, CITY_NM__c, PSTL_AREA_VAL__c, ' +
                'LastModifiedDate, BS_PAY_RT_AMT__c FROM User WHERE GM_LOC_ID__c = APPLY_USER_LOCATION',
            optimization: true,
        ...
        },
        {
            ...
            initQuery:
                ...
                'InstructionDescription, Sales_Visit__c, Check_In_Location_Flag__c, Pull_Number__c, Manager_Ad_Hoc__c, Check_Out_Location_Flag__c, ' +
                'Customer_ID__c, RTE_ID__c, Route_Group__c, Reassigned_Flag__c, Dynamic_Frequency_Add__c, Dynamic_Frequency_Remove__c, AccountId, Reassigned__c FROM Visit WHERE Retail_Store__r.LOC_PROD_ID__c = APPLY_USER_LOCATION AND Planned_Date__c >= LAST_N_DAYS:14:DATE ' +
                "AND Status__c != 'Pre-Processed'",
            optimization: true,
            optimizationQuery:
                " AND ((Status__c != 'Removed' AND Status__c != 'Failed' AND Dynamic_Frequency_Remove__c = false) OR (Dynamic_Frequency_Remove__c = true AND Status__c = 'Removed'))",
            fieldList: [
                {
                    name: 'Id',
                    type: 'string'
        ...
        },
        {
            ...
            initQuery:
                ...
                'Merchandising_Base__c, LastModifiedDate, manager__c, relationship_begin_date__c, relationship_end_date__c, ' +
                'relationship_active__c, RecordTypeId, Schedule_Favorited__c, Manager_Directs__c, Is_Night_Shift__c FROM ' +
                "User_Stats__c WHERE USER__r.GM_LOC_ID__c = APPLY_USER_LOCATION AND RecordType.DeveloperName = 'Stats'",
            optimization: true,
            ...
            fieldList: [
                ...
                {
                    name: 'relationship_begin_date__c',
                    type: 'string'
                },
                {
                    name: 'relationship_end_date__c',
                    type: 'string'
                },
                {
                    name: 'relationship_active__c',
                    type: 'boolean'
                },
                {
                    name: 'RecordTypeId',
        ...
        },
        {
            ...
            soupName: 'Account',
            initQuery:
                'SELECT Id, CUST_GEOFNC__c, Name, Phone, Merchandising_Base__c, BUSN_SGMNTTN_LVL_1_NM__c, ' +
                'BUSN_SGMNTTN_LVL_2_NM__c, BUSN_SGMNTTN_LVL_3_NM__c, Sales_Route__c, Sales_Rep__c, ' +
                'LastModifiedDate, Indicator_2P__c, ShippingAddress, CUST_UNIQ_ID_VAL__c, RTLR_STOR_NUM__c, ' +
                'Merchandising_Base_Minimum_Requirement__c, CUST_ID__c, Merchandising_Order_Days__c, Merchandising_Delivery_Days__c, ' +
                'IS_ACTIVE__c, Active_Dist_Points__c, Sales_Rep_Info__c, LOC_PROD_ID__c, Go_Kart_Flag__c ' +
                'FROM Account ' +
                "WHERE LOC_PROD_ID__c = APPLY_USER_LOCATION AND IS_ACTIVE__c = true AND CUST_LVL__C =  'Customer Outlet'",
            optimization: true,
        ...
        },
        {
            ...
            initQuery: `SELECT Id, Customer__r.Id,
            ...
            SLS_MTHD_CDE__c, ORD_DAYS__c, IsRemoved__c, LastModifiedDate FROM Customer_to_Route__c
            WHERE RecordType.DeveloperName = 'CTR' AND Route__c IN (SELECT Id FROM Route_Sales_Geo__c WHERE LOC_ID__c = APPLY_USER_LOCATION) `,
            optimization: true,
        ...
        },
        {
            ...
            initQuery:
                ...
                'AND ((ExpectedDeliveryDate >= LAST_N_DAYS:14:TIME AND ExpectedDeliveryDate <= NEXT_N_DAYS:35:TIME) OR ' +
        ...
        },
        {
            ...
            initQuery: `SELECT Id, Name, Route__c, User__c, LastModifiedDate FROM Employee_To_Route__c where route__c in (SELECT Id FROM Route_Sales_Geo__c WHERE 
                LOC_ID__c = APPLY_USER_LOCATION) AND Active_Flag__c = true`,
            optimization: true,
        ...
        },
        {
            ...
            fieldList: [
                ...
                {
                    name: 'Shipment.ActualDeliveryDate',
                    type: 'string'
                },
                {
                    name: 'Shipment.Retail_Store__c',
                    type: 'string'
                },
                {
                    name: 'Shipment.Extract_Eff_Date__c',
                    type: 'string'
                },
                {
