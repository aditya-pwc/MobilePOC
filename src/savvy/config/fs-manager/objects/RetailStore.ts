export default {
    ...
    fieldList: [
        ...
        {
            name: 'Account.Delta_Volume_Percentage__c',
            type: 'number'
        },
        {
            name: 'Account.CY_LCW_Volume__c',
            type: 'number'
        },
        {
            name: 'Account.CY_LCW_Revenue__c',
            type: 'number'
        },
        {
            name: 'Account.Delta_Volume__c',
            type: 'number'
        },
        {
            name: 'Account.Delta_Revenue__c',
            type: 'number'
        },
        {
            name: 'CreatedDate',
