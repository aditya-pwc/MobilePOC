...
const MerchManagerConfig = {
    name: 'Merch Manager',
    tab: ['Copilot', 'My Day', 'My Team', 'My Customers', 'Notifications'],
    objs: [
        ...baseObjects,
        Contract,
        RetailVisitKpi,
        ...
        },
        {
            ...
            initQuery: `SELECT Id, CountryCode, Name, Street, City, State, Country, PostalCode, Latitude, Longitude, 
                ...
                LocationId, Account.CUST_GEOFNC__c, Account.CUST_UNIQ_ID_VAL__c, LastModifiedDate, MapstedPropertyId__c,
                ...
                Account.Serves_Dinner__c, Account.Go_Kart_Flag__c,Account.IsCDACustomer__c,Account.IsOTSCustomer__c,
                Account.CDA_Medal__c, Account.GSC_ID__c, Customer_Latitude__c, Customer_Longitude__c FROM RetailStore WHERE Account.LOC_PROD_ID__c = APPLY_USER_LOCATION`,
            optimization: true,
        ...
        },
        {
            ...
            initQuery:
                ...
                'LastModifiedDate, Email, BS_PAY_RT_AMT__c FROM User WHERE GM_LOC_ID__c = APPLY_USER_LOCATION',
            optimization: false,
        ...
        },
        {
            ...
            initQuery:
                ...
                'Customer_ID__c, Sales_Visit__c, RTE_ID__c, Route_Group__c, Reassigned_Flag__c, Dynamic_Frequency_Add__c, Dynamic_Frequency_Remove__c, AccountId, Reassigned__c ' +
            ...
            optimization: true,
            optimizationQuery:
                " AND ((Status__c != 'Removed' AND Status__c != 'Failed') OR (Dynamic_Frequency_Remove__c = true AND Status__c = 'Removed'))",
            fieldList: [
                {
                    name: 'Id',
                    type: 'string'
        ...
        },
        {
            ...
            {Visit_List__c:Unassigned_Time__c},
        ...
        },
        {
            ...
            soupName: 'Account',
            initQuery:
                'SELECT Id, Name, Phone, Merchandising_Base__c, BUSN_SGMNTTN_LVL_1_NM__c, ' +
                `BUSN_SGMNTTN_LVL_2_NM__c, BUSN_SGMNTTN_LVL_3_NM__c, Sales_Route__c, Sales_Rep__c, 
            LastModifiedDate, Indicator_2P__c, ShippingAddress, Go_Kart_Flag__c, LOC_PROD_ID__c, 
            CUST_ID__c, CUST_UNIQ_ID_VAL__c ` +
                `FROM Account ` +
        ...
        },
        {
            ...
            initQuery:
                'SELECT Id, OwnerId, Route__c, Merch_Flag__c, Customer__c, ACTV_FLG__c, RecordTypeId, ' +
                'SLS_MTHD_CDE__c, IsRemoved__c, LastModifiedDate FROM Customer_to_Route__c WHERE Merch_Flag__c = true ' +
                "AND RecordType.DeveloperName = 'CTR' AND Route__c IN (SELECT Id FROM Route_Sales_Geo__c WHERE LOC_ID__c = APPLY_USER_LOCATION)",
            optimization: true,
        ...
        },
        {
            ...
            initQuery: `SELECT Id, Name, Route__c, User__c, LastModifiedDate, User__r.Name FROM Employee_To_Route__c where route__c in (SELECT Id FROM Route_Sales_Geo__c WHERE 
...
export default MerchManagerConfig
