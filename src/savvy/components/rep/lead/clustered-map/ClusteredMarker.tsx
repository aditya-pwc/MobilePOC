...
import { returnMarkerStyle } from './ClusteredMaphelpers'
...
const ClusteredMarker = (props: {
    ...
    const { geometry, properties, onPress, clusterColor, clusterTextColor, clusterFontFamily, tracksViewChanges } =
        props
